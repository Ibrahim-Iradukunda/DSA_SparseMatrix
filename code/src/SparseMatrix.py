...
if __name__ == "__main__":
    ...
    input_file = os.path.expanduser("~/DSA_SparseMatrix/sample_inputs/sample_02.txt")
    output_file = os.path.expanduser("~/DSA_SparseMatrix/sample_results/sample_02_results.txt")

    sparse_matrix.processFile(input_file, output_file)

    # Print the output file contents to verify results
    print("\n🔹 Processed Unique Integers:")
